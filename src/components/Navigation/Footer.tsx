        ...
        <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
          ...
          <nav aria-label="Footer Nav" className="mt-12">
            <ul className="flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
              ...
              <li>
                <Link className="text-gray-700 transition hover:text-gray-700/75" href="/about-us">
                  About Us
                </Link>
              </li>
              ...
              <li>
                <Link className="text-gray-700 transition hover:text-gray-700/75" href="/events">
                  Events
                </Link>
              </li>

              <li>
                <Link className="text-gray-700 transition hover:text-gray-700/75" href="/join-us">
                  Join Us
                </Link>
              </li>

              <li>
                <Link className="text-gray-700 transition hover:text-gray-700/75" href="/sign-in">
                  Portal
                </Link>
              </li>
            </ul>
