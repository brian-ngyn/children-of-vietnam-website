...
const OpenExecPositionCard = ({ openExecPosition }: OpenExecPositionCardProps) => {
  ...
  return (
    <>
      <div className="flex items-stretch flex-col w-full h-full rounded-lg border bg-gray-100 p-4 shadow-lg transition hover:shadow-xl sm:p-6 shadow-black-200">
        <div className="grow">
          <div>
