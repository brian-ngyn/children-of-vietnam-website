...
const PastEventsRow = ({ event }: EventProps) => {
  ...
  return (
    <>
      <tr>
        <td className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">{eventTitle}</td>
        ...
        <td className="whitespace-nowrap px-4 py-2 text-gray-700">{eventLocation}</td>
