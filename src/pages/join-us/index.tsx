                    ...
                    >
                      <div className="sm:flex-1">
                        <input
                          ...
                          className="w-full rounded-md border border-gray-200 bg-gray-100 p-3 text-gray-700 shadow-md transition focus:border-white focus:outline-none focus:ring focus:ring-my-blue"
                        />
                      </div>
